    ...
    <div class="row">
        ...
        <div class="col-md-10 mt-3">
            ...
            <div class="row mt-4">
              ...
              if( strcmp($jp['j_p'],'P')){
                  ?>
                   <button style='color:white;font-size:18px; background-color:black;padding:15px;font-family: Verdana, Geneva, Tahoma, sans-serif;' type="submit" class="btn" style="width: 220px;"name='update' id='update'> <a style='color:white;text-decoration:none;'href='judContest.php'>Back </a></button>
                  <?php
              }else{?>
                <button style='color:white;font-size:18px; background-color:black;padding:15px;font-family: Verdana, Geneva, Tahoma, sans-serif;' type="submit" class="btn" style="width: 220px;"name='update' id='update'> <a style='color:white;text-decoration:none;'href='parContest.php'>Back </a></button><?php }?>
                </div>
            </div>
        </div>        
</div>

...
$dum=$i['id'];
$contest= mysqli_query($connection,"SELECT `contest_id` FROM `result` where `id`='$dum' and `j_p`='p'");
$con = [];
$conid = [];
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-10 mt-3">
            <div class="row">
                <label style='color:black; font-size:24px; font-family: Verdana, Geneva, Tahoma, sans-serif;'>Registered Contests</label>
                <br/><br/>
                <br/>
                <div>
                </div>
